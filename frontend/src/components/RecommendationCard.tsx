    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm capitalize text-cyan-300">{recommendation.category}</p>
        </div>
        <span className="rounded-full bg-emerald-500/15 px-3 py-1 text-sm font-medium text-emerald-300">
          {formatScore(recommendation.compatibilityScore)}
        </span>
      </div>
